...
coffeechain <- sqlQuery(con, 'CoffeeChain Query')
...
The code chunk below is used to compute the minimum, maximum and end of month sales.
...
Next, you will need to load the package onto R environment by using the code chunk below.
