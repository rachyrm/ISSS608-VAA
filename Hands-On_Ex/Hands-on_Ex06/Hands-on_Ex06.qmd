...
In this exercise, we will be using R packages to do the following data visualisations:
...
The following R packages will be used for the exercise: scales, viridis, lubridate, ggthemes, gridExtra, readxl, knitr, data.table and tidyverse.
...
The goal by the end of this section is to:
