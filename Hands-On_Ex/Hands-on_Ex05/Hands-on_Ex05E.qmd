...
In this hands-on exercise, I will be designing treemap using appropriate R packages. The hands-on exercise consists of three main sections:

1.  First, how to manipulate transaction data into a treemap strcuture by using selected functions provided in **dplyr** package.

2.  Then, how to plot static treemap by using **treemap** package.

3.  Lastly, how to design interactive treemap by using **d3treeR** package.

# Installing and Launching R Packages

Before we get started, check if **treemap** and **tidyverse** packages have been installed in you R.
...
Those who are new to **dplyr** methods should consult [Introduction to dplyr](https://cran.r-project.org/web/packages/dplyr/vignettes/dplyr.html) before moving on to the next section.
:::
